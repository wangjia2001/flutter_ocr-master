...
import 'ViewSuppply.dart';

class SecondListCard extends StatefulWidget {
  final SecondCompanyModel _company;
  SecondListCard(this._company);
  @override
  _SecondListCardState createState() => _SecondListCardState();
}

class _SecondListCardState extends State<SecondListCard> {
  @override
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ViewSupply(), //供货单信息
                      settings: RouteSettings(
                        arguments: company, //传值
                      ),
                    ),
