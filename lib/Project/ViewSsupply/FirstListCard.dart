...
import 'SecondCompanyInfoPage.dart';
import 'SecondDialoguePage.dart';
import 'Model/SecondCompanyModel.dart';
import 'SecondViewSupply.dart';

class FirstListCard extends StatefulWidget {
  final SecondCompanyModel _company;
  FirstListCard(this._company);
  @override
  _FirstListCardState createState() => _FirstListCardState();
}

class _FirstListCardState extends State<FirstListCard> {
  //当选项为yes的跳转

  @override
  Widget build(BuildContext context) {
    //需要从ForumPage中得到数据
    SecondCompanyModel company = widget._company;
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SecondViewSupply(), //供货单信息
                      settings: RouteSettings(
                        arguments: company, //传值
                      ),
                    ),
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) => new SecondDialogue()),
                  );
                },
              ),
              new Text(
