...
import 'transfor_page.dart';
// import 'package:flutter_ocr/Template/TemplatePage.dart';
...
class _CropPageState extends State<CropPage>
  ...
  String baiduClientId = "Ww4NWD4p0lAsTVuRc5M6NB20";
  String baiduClientSecret = "NQ87RgTbDwKkF8QICOGsQCr3i9Dv5ZYx";
  ...
  Future<void> _capturePng() async {
    ...
    Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) => new TransforPage(
  ...
  void onScaleUpdate(ScaleRotateUpdateDetails details) {
    ...
    if (details.scale == 1 && details.rotation == 0) {
      ...
      //    if(dx <= (10-this.context.size.width)){
      //      dx = 10-this.context.size.width;
      //    }
      //    if(dx >= this.context.size.width-10){
      ...
      //
      //    if(dy <= (10-imageHeight)){
      //      dy = 10-imageHeight;
      //    }
      //    if(dy >= this.context.size.height+imageHeight-10){
