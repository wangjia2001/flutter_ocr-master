...
class TransforPage extends StatefulWidget {
  ...
  TransforPage({Key key, @required this.username, this.ocrContent})
      : super(key: key);
  final List<String> ocrContent;

  @override
  _TransforPageState createState() {
    perid = username;
    return _TransforPageState();
  }
}
...
// 把东西存起来
  ...
  Widget build(BuildContext context) {
    if ((widget.ocrContent != null) && (list.length == 0)) {
      list.addAll(widget.ocrContent);
      print("add ocr list------------");
      print(list);
    }
    print("use——------------------r" + user);
                  ...
                  children: [
                    ...
                    TableRow(
                        ...
                        children: [
                          TableCell(
                              child: Text(
                            list.length > 3 ? list[3] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                          )),
                          TableCell(
                              child: Text(
                            list.length > 4 ? list[4] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontWeight: FontWeight.w900,
                    ...
                    TableRow(
                        ...
                        children: [
                          TableCell(
                              child: Text(
                            list.length > 6 ? list[6] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                          )),
                          TableCell(
                              child: Text(
                            list.length > 7 ? list[7] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontWeight: FontWeight.w900,
                    ...
                    TableRow(
                        ...
                        children: [
                          TableCell(
                              child: Text(
                            list.length > 12 ? list[12] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                          )),
                          TableCell(
                              child: Text(
                            list.length > 13 ? list[13] : " ",
                            softWrap: true,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontWeight: FontWeight.w900,
